...
import { Card, Form, Input, Button, Typography, message, Spin, Popconfirm, Select, Tabs } from 'antd';
import { ArrowLeftOutlined, SafetyOutlined } from '@ant-design/icons';
import { appService } from '../../services/app.service';
import { Application, AppStatus } from '@lowcode/shared';
import AppRoleManager from './AppRoleManager';
      ...
      <Tabs
        ...
        items={[
          ...
          },
          {
            ...
            children: appId ? <AppRoleManager appId={appId} /> : null,
          },
        ]}
      />
    </div>
